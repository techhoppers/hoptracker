          ...
          $(esqueleto.image).load(this.proxy(function()
            {
              ...
              // Si el tama̱o viene definido en los parametros:
              if (options.width)
              {
                width   = parseInt(options.width, 10);
                height  = parseInt(options.height, 10);
              }
              // Si no sabemos el tama̱o, entonces lo calcularemos:
              else
              {
                ...
                if (options.autoresize)
                {
                  ...
                  // Si el tama̱o calculado no coincide con el tama̱o real, mostraremos la botonera para "agrandar" imagen:
